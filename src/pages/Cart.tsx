      ...
      <header className="glass-effect sticky top-0 z-50 border-b border-white/10">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3 group">
            ...
            <Link to="/" className="text-2xl font-bold bg-gradient-to-r from-primary via-primary to-accent-foreground bg-clip-text text-transparent">
              ArtCanvas
            </Link>
          </div>
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/" className="relative text-foreground hover:text-primary transition-all duration-300 group">
              Home
              ...
              <CardContent>
                {state.items.length === 0 ? (
                  <div className="text-center py-16">
                    ...
                    <p className="text-muted-foreground mb-8">Discover amazing digital artwork to transform your space</p>
                  ...
                  <div className="space-y-6">
                    {state.items.map((item) => (
                      <div key={item.id} className="flex items-center gap-4 p-4 rounded-xl glass-effect border border-border/20 hover:border-primary/30 transition-all duration-300">
                        {/* Item Image */}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-muted-foreground mb-2">{item.category} • Digital Download</p>
                          <p className="text-sm text-muted-foreground">24x36 inches • 300 DPI • Instant Download</p>
                        </div>
